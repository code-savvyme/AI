...
void printMST(vector<edge> MST) {
    int total_weight = 0;  // 🌟 Add a variable to track total weight
    ...
    for(auto edge : MST) {
        cout << '\n'
             ...
             << "wt : " << edge.wt << '\n'
             << '\n';
        total_weight += edge.wt;  // 🌟 Add each weight
    }

    cout << "Total weight of MST: " << total_weight << endl;  // 🌟 Print total weight
}
